# Script for watermark rendering evaluation without any model reasoning, just for response filtering. 
...
# 3. The prompt ids corresponding to the designed prompts in step 10 below (line 26).
