...
if __name__ == '__main__':
    ...
    vision_tower_high_weights_path = '/path/to/vision_tower_high_weights.pth'
    vision_tower_high_weights = torch.load(vision_tower_high_weights_path)
    
    net = build_vary_vit_b()
    net.load_state_dict(vision_tower_high_weights)
