...
def eval_model(args):
    ...
    # qs = '\n Find the text question in this image and try to give the answer'
    # qs = '\n Read the sentence in this image'
    # qs = '\n You will find a sentence in this image, which is the question that you need to answer based on the total image'
    # qs = '\nPlease provide the bounding box coordinate of the region this sentence describes: child wearing white shirt with black collar.'
    # qs = '\n Find the text in this image'
    qs = '\n'
