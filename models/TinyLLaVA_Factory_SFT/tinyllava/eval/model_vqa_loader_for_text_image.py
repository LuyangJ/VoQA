...
def eval_model(args):
    ...
    model.to(torch.bfloat16) # For Qwen2-0.5B Model 后续考虑加一个自动判断，转换model,image tensor, text image tensor的精度
...
if __name__ == "__main__":
    ...
    parser.add_argument("--text-image-folder", type=str, default="")  # 新增参数
