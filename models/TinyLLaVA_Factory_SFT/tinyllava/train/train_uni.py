...
from tinyllava.data.dataset import make_supervised_data_module, make_supervised_data_module_for_uni_model
...
def train():
    ...
    data_module = make_supervised_data_module_for_uni_model(tokenizer=tokenizer,
